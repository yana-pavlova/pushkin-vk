    ...
    $.dlxQuiz = function ( element, options ) {
      var plugin = this,
        ...
        defaults = {
          ...
          resultsHeader_text: "Пушкин оглашает результаты.",
          quizScore_text: "Верных ответов %totalScore из %totalQuestions.",
          quizScoreMessage_text: "",
          quizScoreRank_text: {
            a: "Отличный результат! Пушкин гордился бы тобой!",
            b: "Хорошая работа! Пушкин доволен!",
            c: "Будь Пушкин учителем, он бы поставил тебе четыре с огрооомным минусом",
            d: "Пушкин советует тебе подучить стихи!",
            f: "Пушкин сокрушённо качает головой"
          },
