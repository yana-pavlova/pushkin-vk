...
var Quiz26 = {
    q: `<table border="0">
    <tr>
        <td>Вместе они любили</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>сидеть на склоне <img class="emojiIcon" src=images/emodji/mountain.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Оттуда видны им были</td>
        <td>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/church.png>, сады, тюрьма.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Оттуда они видали</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>заросший травой <img class="emojiIcon" src=images/emodji/sea.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Сбросив в песок сандалии,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>сидели они вдвоем.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Руками обняв колени,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>смотрели они в <img class="emojiIcon" src=images/emodji/cloud.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Внизу у кино калеки</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>ждали <img class="emojiIcon" src=images/emodji/blue_car.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Мерцала на склоне банка</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>возле кустов кирпича.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Над розовым шпилем банка</td>
        <td>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/crow.png> вилась, крича.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Машины ехали в центре</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>к бане по трем <img class="emojiIcon" src=images/emodji/bridge_at_night.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Колокол звякал в церкви:</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>электрик венчался там.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>А здесь на <img class="emojiIcon" src=images/emodji/mountain.png> было тихо,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>ветер их освежал.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Кругом ни свистка, ни крика.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Только комар жжужал.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/grass2.jpg> была там примята,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>где сидели они всегда.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Повсюду черные пятна —</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>оставила их еда.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/cow.png> всегда это место</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>вытирали своим <img class="emojiIcon" src=images/emodji/tongue.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Всем это было известно,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>но они не знали о том.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Окурки, спичка и <img class="emojiIcon" src=images/emodji/fork.jpg></td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>прикрыты были песком.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Чернела вдали <img class="emojiIcon" src=images/emodji/bottle.png>,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>отброшенная носком.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Заслышав едва мычанье,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>они спускались к <img class="emojiIcon" src=images/emodji/bush.png></td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>и расходились в молчаньи —</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>как и сидели там.</td>
        <td>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>По разным склонам спускались,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>случалось боком ступать.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/bush.png> перед ними смыкались</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>и расступались опять.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Скользили в траве <img class="emojiIcon" src=images/emodji/boot.png>,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>меж камней блестела <img class="emojiIcon" src=images/emodji/droplet.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Один достигал тропинки,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>другой в тот же миг пруда.</td>
        <td>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Был вечер нескольких <img class="emojiIcon" src=images/emodji/wedding.png></td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>(кажется, было две).</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Десяток рубах и <img class="emojiIcon" src=images/emodji/dress.png></td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>маячил внизу в <img class="emojiIcon" src=images/emodji/grass.jpg>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Уже <img class="emojiIcon" src=images/emodji/sunrise.png> унимался</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>и <img class="emojiIcon" src=images/emodji/cloud.png> к себе манил.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Пар от <img class="emojiIcon" src=images/emodji/earth_americas.png> поднимался,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>а <img class="emojiIcon" src=images/emodji/bell.png> все звонил.</td>
        <td>
        <input>
        </td>
    </tr>
    ...
    <tr>
        <td>Один, кряхтя, спотыкаясь,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>другой, <img class="emojiIcon" src=images/emodji/cigarette.png> дымя —</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>в тот вечер они спускались</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>по разным склонам <img class="emojiIcon" src=images/emodji/mountain.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Спускались по разным склонам,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>пространство росло меж них.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Но страшный, одновременно</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>воздух потряс их крик.</td>
        <td>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Внезапно <img class="emojiIcon" src=images/emodji/bush.png> распахнулись,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>кусты распахнулись вдруг.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Как будто они проснулись,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>а <img class="emojiIcon" src=images/emodji/sleeping.png> их был полон мук.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Кусты распахнулись с воем,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>как будто раскрылась <img class="emojiIcon" src=images/emodji/earth_africa.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Пред каждым возникли двое,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>железом в руках шевеля.</td>
        <td>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Один <img class="emojiIcon" src=images/emodji/axe.png> был встречен,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>и <img class="emojiIcon" src=images/emodji/blood.jpg> потекла по часам,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>другой от разрыва <img class="emojiIcon" src=images/emodji/heart.png></td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>умер мгновенно сам.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Убийцы тащили их в рощу</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>(по рукам их струилась кровь)</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>и бросили в <img class="emojiIcon" src=images/emodji/pond.jpg> заросший.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>И там они встретились вновь.</td>
        <td>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Еще пробирались на ощупь</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>к местам за столом <img class="emojiIcon" src=images/emodji/groom.png>,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>а страшную весть на площадь</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>уже принесли пастухи.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Вечерней <img class="emojiIcon" src=images/emodji/sunrise.png> сияли</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>стада густых облаков.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/cow.png> в кустах стояли</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>и жадно лизали <img class="emojiIcon" src=images/emodji/blood.jpg>.</td>
        <td>
        <input>
        </td>
    </tr>
    ...
    <tr>
        <td>Электрик бежал по склону</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>и шурин за ним в <img class="emojiIcon" src=images/emodji/bush.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Невеста внизу обозленно</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>стояла одна в <img class="emojiIcon" src=images/emodji/sunflower.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/older_woman.png>, укрытая пледом,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>крутила пред ней тесьму,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>а пьяная свадьба следом</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>за ними неслась к <img class="emojiIcon" src=images/emodji/mountain.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    ...
    <tr>
        <td>Сучья под ними трещали,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>они неслись, как в бреду.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/cow.png> в кустах мычали</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>и быстро спускались к <img class="emojiIcon" src=images/emodji/pond.jpg>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>И вдруг все увидели ясно</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>(царила вокруг жара):</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>чернела в зеленой ряске,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>как <img class="emojiIcon" src=images/emodji/door.png> в темноту, дыра.</td>
        <td>
        <input>
        </td>
    </tr>
    ...
    <tr>
        <td>Кто их оттуда поднимет,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>достанет со дна <img class="emojiIcon" src=images/emodji/pond.jpg> ?</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/death.jpeg>, как вода над ними,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>в желудках у них <img class="emojiIcon" src=images/emodji/droplet.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Смерть уже в каждом слове,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>в <img class="emojiIcon" src=images/emodji/grass_rice.png>, обвившем жердь.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Смерть в зализанной крови,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>в каждой <img class="emojiIcon" src=images/emodji/cow.png> смерть.</td>
        <td>
        <input>
        </td>
    </tr>
    ...
    <tr>
        <td><img class="emojiIcon" src=images/emodji/death.jpeg> в погоне напрасной</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>(будто ищут воров).</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Будет отныне красным</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>млеко этих коров.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>В красном, красном <img class="emojiIcon" src=images/emodji/train.png></td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>с красных, красных путей,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>в красном, красном бидоне —</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>красных поить <img class="emojiIcon" src=images/emodji/baby.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    ...
    <tr>
        <td>Смерть в голосах и <img class="emojiIcon" src=images/emodji/eyes.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Смертью полн воротник. —</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Так им заплатит <img class="emojiIcon" src=images/emodji/city_sunset.png>:</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>смерть тяжела для них.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Нужно поднять их, поднять бы.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Но как превозмочь тоску:</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>если убийство в день <img class="emojiIcon" src=images/emodji/wedding.png>,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>красным быть молоку.</td>
        <td>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><img class="emojiIcon" src=images/emodji/death.jpeg> — не скелет кошмарный</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>с длинной косой в росе.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Смерть — это тот кустарник,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>в котором стоим мы все.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Это не плач похоронный,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>а также не черный <img class="emojiIcon" src=images/emodji/bow2.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Смерть — это крик <img class="emojiIcon" src=images/emodji/crow.png>,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>черный — на красный банк.</td>
        <td>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Смерть — это все <img class="emojiIcon" src=images/emodji/blue_car.png>,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>это тюрьма и сад.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Смерть — это все <img class="emojiIcon" src=images/emodji/man.png>,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/bowtie.png> их висят.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Смерть — это стекла в бане,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>в <img class="emojiIcon" src=images/emodji/church.png>, в домах — подряд!</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Смерть — это все, что с нами —</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>ибо они — не узрят.</td>
        <td>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Смерть — это наши силы,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>это наш труд и пот.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Смерть — это наши жилы,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>наша душа и плоть.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Мы больше на <img class="emojiIcon" src=images/emodji/mountain.png> не выйдем,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>в наших <img class="emojiIcon" src=images/emodji/house.png> огни.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Это не мы их не видим —</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>нас не видят они.</td>
        <td>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><img class="emojiIcon" src=images/emodji/rose2.png>, герань, гиацинты,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>пионы, сирень, ирис —</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>на страшный их <img class="emojiIcon" src=images/emodji/coffin.png> из цинка —</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>розы, герань, нарцисс,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>лилии, словно из басмы,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>запах их прян и дик,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>левкой, орхидеи, астры,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/rose.png> и сноп гвоздик.</td>
        <td>
        <input>
        </td>
    </tr>
    ...
    <tr>
        <td>Прошу отнести их к брегу,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>вверить их небесам.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>В реку их бросить, в <img class="emojiIcon" src=images/emodji/river.png>,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>она понесет к <img class="emojiIcon" src=images/emodji/forest.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>К черным лесным протокам,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>к темным лесным <img class="emojiIcon" src=images/emodji/house.png>,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>к мертвым полесским топям,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>вдаль — к балтийским холмам.</td>
        <td>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><img class="emojiIcon" src=images/emodji/mountain.png> — это наша юность,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>гоним ее, не узнав.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Холмы — это сотни улиц,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>холмы — это сонм канав.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Холмы — это боль и гордость.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Холмы — это край <img class="emojiIcon" src=images/emodji/earth_africa.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Чем выше на них восходишь,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>тем больше их видишь вдали.</td>
        <td>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Холмы — это наши страданья.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Холмы — это наша <img class="emojiIcon" src=images/emodji/heart.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Холмы — это крик, рыданье,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>уходят, приходят вновь.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/light.png> и безмерность боли,</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>наша тоска и страх,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>наши мечты и горе,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>все это — в их <img class="emojiIcon" src=images/emodji/bush.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    ...
    <tr>
        <td>Холмы — это вечная слава.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Ставят всегда напоказ</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>на наши страданья право.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Холмы — это выше нас.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>Всегда видны их вершины,</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>видны средь кромешной <img class="emojiIcon" src=images/emodji/black_circle.png>.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Присно, вчера и ныне</td>
        <td>
        </td>
    </tr>
    <tr>
        <td>по склону движемся мы.</td>
        <td>
        </td>
    </tr>
    <tr>
        <td><img class="emojiIcon" src=images/emodji/death.jpeg> — это только равнины.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        <td>Жизнь — <img class="emojiIcon" src=images/emodji/mountain.png>, холмы.</td>
        <td>
        <input>
        </td>
    </tr>
    <tr>
        ...
        <td>
           <button class="btn-show-results" onclick="showResults(event, Quiz26, quiz26)">
               <a href="/emodji">Узнать результаты</a>
           </button>
        </td>
    </tr>
