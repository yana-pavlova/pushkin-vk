...
function (_hyperHTML$Component) {
  ...
  _createClass(RegisterPage, [{
    ...
    value: function render() {
      var firstPart = hyperHTML.wire()(_templateObject(), this.state.availableAuthors.map(function (author) {
        return hyperHTML.wire()(_templateObject2(), author.name.first, author.name.last, author.patronymic);
      }));
