    ...
    value: function render() {
      ...
      if (this.myAuthors.length) {
        myAuthors = hyperHTML.wire()(_templateObject(), this.myAuthors.map(function (a) {
          return hyperHTML.wire()(_templateObject2(), a.name.first, a.name.last, a.patronymic, a._id, _this2.changeCurrentAuthor);
        }));
      }
