...
function (_hyperHTML$Component3) {
  ...
  _createClass(AuthorsPage, [{
    ...
    value: function addNewPost(e) {
      ...
      queryArray.push("author=".concat(_LOCALS.user.currentAuthorId));
    ...
    value: function render() {
      console.log(this);
      return this.html(_templateObject3(), new NavBar(this.state), new AuthorSidebar(this.state.author), _LOCALS.isSignedIn && _LOCALS.user.currentAuthorId == this.state.author._id ? hyperHTML.wire()(_templateObject4(), new PostEditor({
        that: this,
        autoFocus: false,
        post: '',
        class: '',
