...
button21.onclick = function() {
    story20.style.display = "none";
    story21.style.display = "block";
}
button22.onclick = function() {
    story21.style.display = "none";
    story22.style.display = "block";
}

button23.onclick = function() {
    story22.style.display = "none";
    story23.style.display = "block";
}
button24.onclick = function() {
    story23.style.display = "none";
    story24.style.display = "block";
}

button25.onclick = function() {
    story24.style.display = "none";
    story25.style.display = "block";
}
button26.onclick = function() {
    story25.style.display = "none";
    story26.style.display = "block";
}

button27.onclick = function() {
    story26.style.display = "none";
    story27.style.display = "block";
}
button28.onclick = function() {
    story27.style.display = "none";
    story28.style.display = "block";
}

button29.onclick = function() {
    story28.style.display = "none";
    story29.style.display = "block";
}
button30.onclick = function() {
    story29.style.display = "none";
    story30.style.display = "block";
}

button31.onclick = function() {
    story30.style.display = "none";
    story31.style.display = "block";
}
button32.onclick = function() {
    story31.style.display = "none";
    story32.style.display = "block";
}

button33.onclick = function() {
    story32.style.display = "none";
    story33.style.display = "block";
}
button34.onclick = function() {
    story33.style.display = "none";
    story34.style.display = "block";
}

button35.onclick = function() {
    story34.style.display = "none";
    story35.style.display = "block";
}
button36.onclick = function() {
    story35.style.display = "none";
    story36.style.display = "block";
}

button37.onclick = function() {
    story36.style.display = "none";
    story37.style.display = "block";
}
button38.onclick = function() {
    story37.style.display = "none";
    story38.style.display = "block";
}

button39.onclick = function() {
    story38.style.display = "none";
    story39.style.display = "block";
}
button40.onclick = function() {
    story39.style.display = "none";
    story40.style.display = "block";
}
